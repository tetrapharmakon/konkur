	...
	\begin{itemize}
		...
		\item di essere in possesso del titolo di Dottore di ricerca \myTextField[5cm]{in}, Area \myTextField{CUN}, conseguito \myTextField{presso} [specificare quale, data di conseguimento e istituto]; se il titolo è stato riconosciuto valido in Italia indicare gli estremi del provvedimento di equivalenza/equipollenza:
